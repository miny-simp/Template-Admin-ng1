...
define([], function() {
    ...
    return [{
        ...
        resolve: {
            lazyload: ['$ocLazyLoad', function ($ocLazyLoad) {
                return $ocLazyLoad.load({files: ['role/role-table/role-table-component'], cache: false}).then(function () {
                    $ocLazyLoad.inject('workspace.module');
                });
            }]
        }
        ...
        resolve: {
            lazyload: ['$ocLazyLoad', function ($ocLazyLoad) {
                return $ocLazyLoad.load({files: ['permission/permission-table-component'], cache: false}).then(function () {
                    $ocLazyLoad.inject('workspace.module');
                });
            }]
        }
